...
# Cria o learner. arquitetura InceptionTime
learn = TSClassifier(X=X_all, y=y_all, splits=splits, arch=InceptionTime, tfms=tfms, batch_tfms=batch_tfms, metrics=accuracy)

# Treinamento com o método fit_one_cycle
learn.fit_one_cycle(n_epoch=10, lr_max=1e-3)

#Salva o modelo treinado
PATH = Path('/content/drive/MyDrive/Mestrado/Modelos/InceptionTime/InceptionTime.pkl')
...
plt.savefig("/content/drive/MyDrive/Mestrado/matriz_confusaoInceptionTime.png", dpi=300, bbox_inches='tight')
plt.show()
