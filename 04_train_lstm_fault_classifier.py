...
# Cria o learner. arquitetura LSTM (Long Short-Term Memory)
learn = TSClassifier(X=X_all, y=y_all, splits=splits, arch=LSTM, tfms=tfms, batch_tfms=batch_tfms, metrics=accuracy)

# Treinamento com o método fit_one_cycle (10 épocas e lr_max definido em 1e-3)
learn.fit_one_cycle(n_epoch=10, lr_max=1e-3)

#Salva o modelo treinado
PATH = Path('/content/drive/MyDrive/Mestrado/Modelos/ArchLSTM//LSTM.pkl')
...
plt.savefig("/content/drive/MyDrive/Mestrado/matriz_confusaoLSTM.png", dpi=300, bbox_inches='tight')
plt.show()
